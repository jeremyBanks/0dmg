...
We had the addressed mangled yesterday, so implemented support for a memory range other than the one we actually needed in this case, which is the main Video RAM.
